...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date '+%y.%m.%d.%H.%M.%S'`_tr_stg_teste.log"
...
./pan.sh -file=$KETTLE_HOME/stg/teste.ktr -level=Basic > $log_file
