...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date '+%y.%m.%d.%H.%M.%S'`_tr_stg_ad_reply_faltantes.log"
...
./pan.sh -file=$KETTLE_HOME/stg/tr_stg_ad_reply_faltantes.ktr -level=Basic > $log_file
