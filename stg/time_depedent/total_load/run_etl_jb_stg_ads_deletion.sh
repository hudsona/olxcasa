...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date ‘+%y.%m.%d.%H.%M.%S’`_jb_stg_ads_deletion.log"
...
./kitchen.sh -file=$KETTLE_HOME/stg/total_load/jb_stg_ads_deletion.kjb -level=Basic > $log_file
