...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date '+%y.%m.%d.%H.%M.%S'`_tr_dm_user.log"
...
./pan.sh -file=$KETTLE_HOME/dm/total_load/tr_dm_user.ktr -level=Basic > $log_file
