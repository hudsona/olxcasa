...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date '+%y.%m.%d.%H.%M.%S'`_tr_dm_ad_revenue.log"
...
./pan.sh -file=$KETTLE_HOME/dm/total_load/tr_dm_ad_revenue.ktr -level=Basic > $log_file
