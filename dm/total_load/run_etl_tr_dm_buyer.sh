...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date '+%y.%m.%d.%H.%M.%S'`_tr_dm_buyer.log"
...
./pan.sh -file=$KETTLE_HOME/dm/total_load/tr_dm_buyer.ktr -level=Basic > $log_file
