...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date '+%y.%m.%d.%H.%M.%S'`_tr_dm_seller_incremental.log"
...
./pan.sh -file=$KETTLE_HOME/dm/tr_dm_seller_incremental.ktr -level=Basic > $log_file
