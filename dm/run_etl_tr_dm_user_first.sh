...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date '+%y.%m.%d.%H.%M.%S'`_tr_dm_user_first_novo_06.log"
...
./pan.sh -file=$KETTLE_HOME/dm/tr_dm_user_first_novo_06.ktr -level=Basic > $log_file
