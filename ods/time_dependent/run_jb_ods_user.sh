...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date ‘+%y.%m.%d.%H.%M.%S’`_jb_ods_user.log"
...
./kitchen.sh -file=$KETTLE_HOME/ods/time_dependent/jb_ods_user.kjb -level=Basic > $log_file
