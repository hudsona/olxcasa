...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date '+%y.%m.%d.%H.%M.%S'`_tr_ods_ad_view.log"
...
./pan.sh -file=$KETTLE_HOME/ods/time_dependent/tr_ods_ad_view.ktr -level=Basic > $log_file
