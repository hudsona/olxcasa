...
log_file="/opt/dw_schibsted/bomnegocio_bi/dw_blocketdb/logs/`date '+%y.%m.%d.%H.%M.%S'`_tr_ods_ads_deletion.log"
...
./pan.sh -file=$KETTLE_HOME/ods/time_dependent/tr_ods_ads_deletion.ktr -level=Basic > $log_file
